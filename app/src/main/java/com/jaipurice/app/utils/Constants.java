...
public class Constants {
    ...
    public static final String URL_CUSTOMER_LIST = URL_BASE + "customers_list.phprest_api=customers";
//    "http://demoserver.d5infotech.com/jaipur_coldice/API/customers_list.php?rest_api=customers\n"
}
